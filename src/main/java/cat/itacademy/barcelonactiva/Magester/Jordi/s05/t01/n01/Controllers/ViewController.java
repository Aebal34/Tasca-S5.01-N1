...
public class ViewController {
    ...
    public String updateBranchOffice(@ModelAttribute("branchOffice") BranchOfficeDto branchOfficeDto, Model model){

        BranchOfficeDto branchOffice = branchOfficeService.getOne(branchOfficeDto.getPk_ID()).getBody();
